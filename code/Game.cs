...
public partial class SpaceGame : Sandbox.Game
{
	...
	public override async void ClientSpawn()
	{
		...
		/*
		var light = new SceneLight( Dimension1.SceneWorld );
		light.Position = Vector3.One * 50.0f;
		light.Radius = 500.0f;
		light.LinearAttenuation = 15.0f;
		light.QuadraticAttenuation = 0.0f;

		var light2 = new SceneLight( Dimension2.SceneWorld );
		...
		var light3 = new SceneLight( Dimension2.SceneWorld );
		...
		*/
		...
		//DebugOverlay.Sphere( light3.Position, light3.Radius / 10.0f, Color.Orange, 30.0f, depthTest: false );
	}

	[Event.Tick.Server]
	public void Swappy()
	{
		/*foreach ( var ent in Entity.All.OfType<DimensionalModelEntity>() )
		{
			DebugOverlay.Sphere( ent.Position, 0.5f, ent.Dimension == Dimension1 ? Color.Red : Color.Cyan, depthTest: false );
		}*/
